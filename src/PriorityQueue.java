//PriorityQueue word for word from textboot if ignoring comments. Jake 3/27/2018
...
public class PriorityQueue<AnyType> extends AbstractCollection<AnyType> implements Queue<AnyType>
{
   ...
   */
  public PriorityQueue( Copmarator <? super AnyType> c)
  {
    currentSize = 0;
    cmp = c;
    array = (AnyType[]) new Comparable[ DEFAULT_CAPACITY + 1 ];
  ...
  /**
   * Construct an empty PriorityQueue from another collection
   */
